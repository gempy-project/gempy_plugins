...
resulting property field(s). Independent of gempy_viewer -- it has no hook for
arbitrary custom scalar fields, only its own lithology/scalar-field/values arrays -- so
this builds its own pyvista StructuredGrid, mirroring the corner-point/cell-data
construction gempy_viewer itself uses internally.
"""
